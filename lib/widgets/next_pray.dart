    ...
    return Container(
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [const Color(0xff38391a), Colors.transparent],
        ),
...
//   String formatArabicTime(int value, String type) {
//     if (value == 0) return ""; // لو صفر مش هنكتب حاجة
...
//       fontWeight: FontWeight.w900,
//       fontSize: 18,
//       fontFamily: 'Tajawal', // تأكد إنك مستخدم الخط ده لشكل أجمل
//     );
//   }
